...
(window.LT_LESSONS = window.LT_LESSONS || {})['course3/12_trading_sr'] = {
  ...
  beats: [
    ...
    },
    {
      ...
      show: [
        { kind: 'level',  at: 'level', label: 'support', side: 'left', tone: 'support' },
        { kind: 'level',  at: 'stop', label: 'stop — just beneath', side: 'right', tone: 'stop' },
        { kind: 'marker', at: 'touch1', label: 'buy the first test', style: 'reversal', place: 'below' },
        { kind: 'marker', at: 'touch2', label: 'test 2', style: 'dot', place: 'below' },
        { kind: 'marker', at: 'touch3', label: 'weaker each time', style: 'dot', place: 'below' },
        { kind: 'marker', at: 'touch4', label: 'test 4', style: 'dot', place: 'below' },
        { kind: 'marker', at: 'touch5', label: 'the fifth test', style: 'dot', place: 'below' },
        { kind: 'marker', at: 'breakdown', label: 'rule of fives — it breaks', style: 'reversal', place: 'below' }
      ]
    },
    {
      id: 'flip',
      ...
      show: [ { kind: 'level',  at: 'level', label: 'old resistance → support', side: 'left', tone: 'support' },
        { kind: 'marker', at: 'breakout', style: 'dot', place: 'above', label: 'breaks resistance' },
        { kind: 'marker', at: 'retest', label: 'buy the flip retest', style: 'reversal', place: 'below' },
        { kind: 'level',  at: 'stop', label: 'stop — clear invalidation', side: 'right', tone: 'stop' },
        { kind: 'level',  at: 'target', label: 'target', side: 'right', tone: 'target' },
