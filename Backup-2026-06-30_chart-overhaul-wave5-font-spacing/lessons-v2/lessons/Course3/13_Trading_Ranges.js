...
(window.LT_LESSONS = window.LT_LESSONS || {})['course3/13_trading_ranges'] = {
  ...
  beats: [
    ...
    },
    {
      ...
      show: [
        { kind: 'level', at: 'high', label: 'sell here → target the low', side: 'left', tone: 'resistance' },
        { kind: 'level', at: 'low',  label: 'buy here → target the high',  side: 'left', tone: 'support' },
        { kind: 'zone',  side: 'below', of: 'high', tone: 'risk',   label: 'sellers / supply' },
        { kind: 'zone',  side: 'above', of: 'low',  tone: 'reward', label: 'buyers / demand' },
        { kind: 'marker', at: 'touchLo1', label: 'long entry — buy the low', style: 'reversal', place: 'below' },
        { kind: 'marker', at: 'touchHi2', label: 'short entry — sell the high', style: 'reversal', place: 'above' }
      ]
    },
    {
      id: 'tactics',
