...
(window.LT_LESSONS = window.LT_LESSONS || {})['course1/07_what_is_market_structure'] = {
  ...
  beats: [
    ...
    },
    {
      ...
      show: [ { kind: 'marker', at: 'start', style: 'dot', place: 'above', label: 'swing high' }, { kind: 'marker', at: 'low1', style: 'reversal', place: 'below', label: 'swing low' },
        { kind: 'marker', at: 'lh1', label: 'lower high', style: 'dot', place: 'above' },
        { kind: 'marker', at: 'll1', label: 'lower low', style: 'reversal', place: 'below' },
