  ...
  beats: [
    ...
    },
    {
      ...
      show: [
        ...
        { kind: 'marker', at: 'touch2', label: 'rejected', style: 'dot', place: 'above' },
        { kind: 'marker', at: 'touch3', label: 'held 3×', style: 'dot', place: 'above' },
        { kind: 'marker', at: 'touch4', label: 'rejected', style: 'dot', place: 'above' },
        { kind: 'marker', at: 'touch5', label: 'still holding', style: 'dot', place: 'above' }
      ]
    },
    {
      id: 'the-flip',
      ...
      show: [
        { kind: 'level',  at: 'level', label: 'resistance → now support', side: 'left' },
        ...
        { kind: 'level',  at: 'stop', label: 'stop', side: 'right' },
