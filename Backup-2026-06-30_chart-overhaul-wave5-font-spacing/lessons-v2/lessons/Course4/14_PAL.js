  ...
  beats: [
    ...
    },
    {
      ...
      show: [
        ...
        { kind: 'marker', at: 'resTouch1', label: 'reaction 1', style: 'dot', place: 'above' },
        { kind: 'marker', at: 'resTouch2', label: 'reaction 2 — price keeps reacting', style: 'dot', place: 'above' },
        { kind: 'marker', at: 'supTouch1', label: 'reaction 1', style: 'dot', place: 'below' },
        { kind: 'marker', at: 'supTouch2', label: 'reaction 2 — price keeps reacting', style: 'dot', place: 'below' }
      ]
    },
    {
      id: 'use',
