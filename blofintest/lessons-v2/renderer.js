...
(function (g) {
  ...
  var C = { teal: '#04b97d', bear: '#f13c54', gold: '#ffcc00', grid: 'rgba(255,255,255,.05)', level: '#cc4444',
    zoneBull: 'rgba(4,185,125,.10)', zoneBear: 'rgba(241,60,84,.12)', ink: '#e8e8f0', muted: '#8d8aa3',
    markSweep: '#ffb454', markRev: '#04b97d', halo: 'rgba(8,7,15,0.9)' };
...
<div class="ltp2-complete-title"></div>\
  ...
  LTRenderer.prototype._anno = function (P, an, av) {
    ...
    if (an.kind === 'level') {
      ...
      var rgb = an.tone === 'short' ? '241,60,84' : an.tone === 'liq' ? '255,204,0' : '4,185,125';
      var rows = 16;
