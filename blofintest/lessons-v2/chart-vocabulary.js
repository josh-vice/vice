...
(function (g) {
  ...
  function schemeColors(cs, scheme) {
    var P = SCHEME_PALETTE[scheme] || ['#04b97d', '#f23d5c', '#5b5570'];
  ...
  var CHARTS = {
    ...
    ichimoku: function () {
      ...
      var ik = ichimoku(full, { conv: 10, base: 30, span: 78, disp: 30 });
    ...
    color_tool: function (params) {
      ...
      var N = '#5b5570', TQ = '#04b97d', colors, scripted = {};
      if (params && params.script) {
        colors = [N, '#5cc8ff', '#a8ff5b', TQ, '#ff9f43', '#f23d5c', '#f13c54', '#f13c54', '#f13c54',
                  '#c72e42', '#5cc8ff', '#21d196', TQ, TQ, '#ff9f43', '#f23d5c', '#f13c54', '#f13c54', '#f13c54',
                  '#c72e42', '#b06cff', '#ffcf3f', TQ];
    ...
    ichimoku_pocket: function () {
      ...
      var ikP = ichimoku(probePath, { conv: 10, base: 30, span: 78, disp: 30 });
