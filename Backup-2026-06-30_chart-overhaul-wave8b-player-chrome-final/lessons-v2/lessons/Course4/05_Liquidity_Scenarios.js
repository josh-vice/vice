  ...
  beats: [
    ...
    },
    {
      ...
      show: [
        ...
        { kind: 'zone',  side: 'above', of: 'high', tone: 'risk',   label: 'liquidity above — breakout longs / sell stops' },
        { kind: 'zone',  side: 'below', of: 'low',  tone: 'reward', label: 'liquidity below — breakdown shorts / long stops' }
      ]
    },
    {
      id: 'trap',
      ...
      show: [ { kind: 'level',  at: 'target', label: 'target — range high', side: 'right' },
        { kind: 'level',  at: 'support', label: 'range low', side: 'left' },
        { kind: 'level',  at: 'stop', label: 'stop — below the deviation low', side: 'right' },
        { kind: 'marker', at: 'sweepLow', label: 'deviation — shorts trapped', style: 'sweep', place: 'below' },
        { kind: 'marker', at: 'entry', label: 'reclaim = long entry', style: 'reversal', place: 'above' }
      ]
    },
    {
      id: 'manage',
