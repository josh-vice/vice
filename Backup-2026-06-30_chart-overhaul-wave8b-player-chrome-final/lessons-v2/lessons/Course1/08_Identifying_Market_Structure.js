  ...
  beats: [
    ...
    },
    {
      ...
      show: [ { kind: 'level', at: 'rangeLow', side: 'left', label: 'range low', tone: 'reward' },
        ...
        { kind: 'marker', at: 'entry', label: 'new swing high — bullish', style: 'reversal', place: 'above' }
      ]
    },
    {
      id: 'fakeout',
    ...
    },
    {
      ...
      show: [ { kind: 'level', at: 'rangeHigh', side: 'left', label: 'range high', tone: 'risk' },
        ...
        { kind: 'marker', at: 'entry', label: 'breakdown — bearish shift', style: 'reversal', place: 'below' }
      ]
    },
    {
      id: 'recap',
