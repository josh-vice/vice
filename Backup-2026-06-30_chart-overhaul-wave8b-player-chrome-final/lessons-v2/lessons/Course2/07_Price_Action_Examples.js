...
(window.LT_LESSONS = window.LT_LESSONS || {})['course2/07_price_action_examples'] = {
  ...
  beats: [
    ...
    },
    {
      ...
      show: [
        { kind: 'marker', at: 'base', label: 'the base', style: 'dot', place: 'below' },
        { kind: 'marker', at: 'soldier1', label: 'one', style: 'dot', place: 'below' },
        { kind: 'marker', at: 'soldier2', label: 'two', style: 'dot', place: 'below' },
        { kind: 'marker', at: 'soldier3', label: 'three — continuation up', style: 'reversal', place: 'above' }
      ]
    },
    {
      id: 'recap',
