...
(window.LT_LESSONS = window.LT_LESSONS || {})['course4/04_liquidity_structures'] = {
  ...
  beats: [
    ...
    },
    {
      ...
      show: [ { kind: 'marker', at: 'reversalTop', style: 'reversal', place: 'above', label: 'price runs — shorts\' stops become fuel' },
    ...
    },
    {
      ...
      show: [ { kind: 'marker', at: 'reversalBottom', style: 'reversal', place: 'below', label: 'move lower — longs\' stops feed it' },
