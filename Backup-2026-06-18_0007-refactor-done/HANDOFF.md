...
- `Backup-2026-06-17_2106-current/` — **LATEST = current working tree** (code only; audio regenerable).
  Everything below is shipped into it. **Current cache versions (= what's live in `lt-index.html`):**
  `lt-engine.js 3.106.0`, `lt-chartgen.js 1.1.0`, `lt-data.js 1.9.3`, `lt-data-course2.js 1.9.0`,
  `lt-data-course3.js 1.10.0`, `lt-data-course4.js 1.15.0`, `lessons-v2/renderer.js 1.14.0`,
  `lessons-v2/player.css 1.8.0`, `lt-community.js 1.11.1`, `lt-styles.css 1.98.3` (unchanged this run).
