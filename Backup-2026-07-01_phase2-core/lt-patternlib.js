...
(function () {
  ...
  function _biasColor(b) { return b === 'Bullish' ? 'var(--teal,#00d4d4)' : b === 'Bearish' ? 'var(--bear,#ff2e88)' : '#8b85a3'; }

  function _plStyles() {
    if (document.getElementById('lt-patternlib-styles')) return;
    var s = document.createElement('style'); s.id = 'lt-patternlib-styles';
    s.textContent = [
