...
(function () {
  ...
  var T = 'var(--teal,#00d4d4)', G = 'var(--gold,#e7b53a)', GRN = '#21d196', PNK = 'var(--bear,#ff2e88)', S = '#8b85a3';
  ...
  function _ichStyles() {
    if (document.getElementById('lt-ichimoku-styles')) return;
    var s = document.createElement('style'); s.id = 'lt-ichimoku-styles';
    s.textContent = [
