    ...
    1: {
      'Price Action Foundations': {
        ...
        questions: [
          ...
          MC('How many touches create a valid trendline?', ['2', '3', '4', '1'], 1),
      ...
      'Risk Management': {
        ...
        questions: [
          ...
          // Transcript 14 [08:30]: "a few components that we suggest you document religiously — the rest
          // are up to you": the trade-setup parameters (expected RRR, actual R multiple, entry/target/
          // stop-loss/risk%). Emotions/sleep/hunger are explicitly optional ("I like to document…").
          MULTI('At the bare minimum, journaling should include (check all that apply)', ['Trade setup', 'Reasoning', 'Emotions', 'Invalidation levels'], [0, 3])
        ]
      }
    },
    ...
    2: {
      ...
      'Defining a Trade Setup': {
        ...
        questions: [
          ...
          MULTI('Which of the following are valid types of exit strategies (select all that apply)', ['Set & Forget', 'Doubling down when price moves against you', 'Trailing Stop/Loss', 'Partial TP Levels'], [0, 2, 3]),
      ...
      'Price Action Concepts': {
        ...
        questions: [
          ...
          TF('Volume helps confirm candlestick formations', true),
      ...
      'Trading Tools': {
        ...
        questions: [
          ...
          MC('The components of ichimoku are similar to moving averages except they calculate the ___ of the period', ['High', 'Close', 'Low', 'Mean'], 3),
    ...
    3: {
      ...
      'Crafting Your System': {
        ...
        questions: [
          ...
          TF('A system is tuned to the market conditions it performs best in — you can have multiple systems for varying conditions', true),
          ...
          MULTI('Which of the following define a trading plan (select all that apply)', ['Includes a directional bias for the time frame analyzed', 'Builds discipline & consistency', 'Includes markets & key levels to buy or sell', 'Includes rules for executing a trading system'], [0, 1, 2, 3]),
      ...
      'Unlocking Your Potential': {
        ...
        questions: [
          ...
          TF('Systems are static — their parameters should not change with the market', true),
          TF('A systemic edge is an approach based on observation', false),
          TF('A discretionary edge is a set of parameters based on experimentation', false),
    ...
    4: {
      'Identifying Liquidity': {
        ...
        questions: [
          ...
          MC('Game theory helps traders ___', ['Determine who is in control', 'Eliminate the need for technical analysis', 'Predict which way price will go with absolute certainty', 'All of the above'], 0),
      ...
      'Determining Control': {
        ...
        questions: [
          ...
          MC('Price rising while open interest rises suggests ___', ['Strong uptrend (new money)', 'Weak uptrend (unwinding)', 'Strong downtrend (new money)', 'Weak downtrend (unwinding)'], 0),
          MC('Price rising while open interest falls suggests ___', ['Strong uptrend (new money)', 'Weak uptrend (unwinding)', 'Strong downtrend (new money)', 'Weak downtrend (unwinding)'], 1),
          MC('Price falling while open interest rises suggests ___', ['Strong uptrend (new money)', 'Weak uptrend (unwinding)', 'Strong downtrend (new money)', 'Weak downtrend (unwinding)'], 2),
          MC('Price falling while open interest falls suggests ___', ['Strong uptrend (new money)', 'Weak uptrend (unwinding)', 'Strong downtrend (new money)', 'Weak downtrend (unwinding)'], 3),
      ...
      'Applying Sentiment': {
        ...
        questions: [
          ...
          TF('Comparing global accounts with top-trader positions can reveal accumulation or distribution divergences', true),
      ...
      'Ichimoku Masterclass': {
        ...
        questions: [
          ...
          MC('Trading a C-clamp is a ___ strategy', ['Mean reversion', 'Breakout', 'Counter-trend', 'All of the above'], 2),
