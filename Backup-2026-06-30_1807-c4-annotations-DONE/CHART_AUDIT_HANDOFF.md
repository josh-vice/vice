...
| Track | Scope | Status |
|---|---|---|
| **ECharts course charts** (`lt-data*.js` intro/lesson/quiz) | 81 chapters · 231 candlestick charts | **57 chapters audited + APPLIED** (all C1/C2/C3 + C4 ch0,1,2,3,5,6). 94 edits live, verified. |
| **Course 4 remainder** | C4 ch **4, 7–29** (24 chapters) | **NOT audited** — workflow hit the session usage limit. ← next job |
...
`lt-data.js 1.9.5` · `lt-data-course2.js 1.10.0` · `lt-data-course3.js 1.11.0` · `lt-data-course4.js 1.17.0`
...
1. **Audit + apply Course-4 remainder (ch 4, 7–29).** Re-run the audit workflow for just those chapters.
