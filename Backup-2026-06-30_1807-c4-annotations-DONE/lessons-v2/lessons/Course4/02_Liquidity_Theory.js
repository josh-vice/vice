...
(window.LT_LESSONS = window.LT_LESSONS || {})['course4/02_liquidity_theory'] = {
  ...
  beats: [
    ...
    },
    {
      id: 'recap',
      type: 'CONCEPT',
      say: "So those are the four pillars: the game is zero-sum, the players are predatory, they reason via game theory, and price gravitates toward liquidity. Together they let us question the market intelligently — where is the liquidity, who's trapped, and where does price want to go to find it? That question drives the entire rest of this course. Next, we learn to identify liquidity on a chart.",
      panel: {
        title: 'The Four Principles — Recap',
        lines: [
          'Zero-sum · predatory · game theory · seeks liquidity',
          'Together they let us **question the market**',
