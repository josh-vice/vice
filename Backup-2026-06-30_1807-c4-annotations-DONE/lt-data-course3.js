...
const LT_CHAPTERS_3 = [
     ...
     ═══════════════════════════════════════════════════════════════════════ */
  {
    ...
    introChart: {
      ...
      markLines: [ { yAxis: 100, label: "Market Price", color: "#888888" },
     ...
     ═══════════════════════════════════════════════════════════════════════ */
  {
    ...
    introChart: {
      ...
      markLines: [ { yAxis: 84, label: "Bid Wall = Support", color: "#00d4d4" }, { yAxis: 93, label: "Ask Wall = Resistance", color: "#ff2e88" } ],
      type: "candlestick",
      labels: ltLabels(18),
      ohlc: ltCandles(93, [
        { to: 84, bars: 3 },
      ...
      markPoints: [
        { dataIndex:  3, label: "Bid Wall Absorbs",     position: "bottom" },
        { dataIndex:  5, label: "Ask Wall Rejects",     position: "top"    },
        { dataIndex:  8, label: "Bids Refill",          position: "bottom" },
        { dataIndex: 10, label: "Asks Refill",          position: "top"    }
      ]
    },
    ...
    quiz: {
      ...
      chart: {
        ...
        markAreas: [
          ...
          { y0: 91, y1: 97, label: "Ask Zone (Sellers — Red)",  color: "rgba(255,46,136,0.07)"  }
        ]
      },
      revealMarkPoints: [
        { dataIndex:  2, label: "Bids = Green (Buyers)", position: "bottom", color: "#00d4d4" },
        { dataIndex:  4, label: "Asks = Red (Sellers)",  position: "top",    color: "#ff2e88" },
     ...
     ═══════════════════════════════════════════════════════════════════════ */
  {
    ...
    introChart: {
      ...
      markLines: [ { yAxis: 120, label: "Mark Price", color: "#ffcc00" },
    ...
    lessonChart: {
      ...
      markLines: [ { yAxis: 122, label: "Mark Price", color: "#ffcc00" },
     ...
     ═══════════════════════════════════════════════════════════════════════ */
  {
    ...
    quiz: {
      ...
      chart: {
        ...
        markLines: [
          { yAxis: 88, label: "Entry",        color: "#00d4d4" },
          { yAxis: 89, label: "Stop Trigger", color: "#ff2e88" }
        ]
      },
      revealMarkPoints: [
        { dataIndex:  9, label: "Stop Fires — No CoT!",      position: "bottom", color: "#ff2e88" },
        { dataIndex: 11, label: "New Short Opened — Danger", position: "bottom", color: "#ff2e88" },
        { dataIndex: 13, label: "Doubled Loss!",             position: "bottom", color: "#ff2e88" }
      ],
     ...
     ═══════════════════════════════════════════════════════════════════════ */
  {
    ...
    quiz: {
      ...
      revealMarkPoints: [
        { dataIndex:  0, label: "Fund Pay 1",              position: "top", color: "#ff2e88" },
        { dataIndex:  3, label: "Fund Pay 5",              position: "top", color: "#ff2e88" },
        { dataIndex: 10, label: "Fund Pay 15 — Adds Up!", position: "top", color: "#ff2e88" }
      ],
     ...
     ═══════════════════════════════════════════════════════════════════════ */
  {
    ...
    introChart: {
      ...
      markLines: [
        ...
        { yAxis: 83, label: "Isolated Margin Limit",   color: "#ffcc00" }
      ],
      markPoints: [
    ...
    quiz: {
      ...
      chart: {
        ...
        markLines: [
          { yAxis: 88, label: "Entry",           color: "#00d4d4" },
          { yAxis: 83, label: "Stop Loss",       color: "#ff2e88" },
          { yAxis: 73, label: "Isolated Limit",  color: "#ffcc00" }
        ]
      },
      revealMarkPoints: [
     ...
     ═══════════════════════════════════════════════════════════════════════ */
  {
    ...
    quiz: {
      ...
      revealMarkPoints: [
        { dataIndex:  2, label: "Stop Fires at $80",      position: "bottom", color: "#ff2e88" },
     ...
     ═══════════════════════════════════════════════════════════════════════ */
  {
    ...
    lessonChart: {
      ...
      markLines: [ { yAxis: 87, label: "Original Target $160 (R=2.55)", color: "#ffcc00" },
    ...
    quiz: {
      ...
      revealMarkPoints: [
        ...
        { dataIndex: 10, label: "Liq Creeping Up!",       position: "bottom", color: "#ff2e88" }
      ],
     ...
     ═══════════════════════════════════════════════════════════════════════ */
  {
    ...
    introChart: {
      ...
      markLines: [ { yAxis: 82, label: "DBS Top — Highest Open of Down Candle", color: "#00d4d4" }, { yAxis: 77, label: "DBS Bottom — Lowest Wick", color: "#00d4d4" } ],
      type: "candlestick",
      labels: ltLabels(18),
      ohlc: ltCandles(108, [
        { to: 80,  bars: 10 },
    ...
    lessonChart: {
      ...
      markLines: [ { yAxis: 100, label: "SSR Bottom — Lowest Open of Up Candle", color: "#ff2e88" }, { yAxis: 80, label: "Structure Break — Prior Low Taken", color: "#ff2e88" } ],
      type: "candlestick",
      labels: ltLabels(18),
      ohlc: ltCandles(80, [
        { to: 100, bars: 10 },
      ...
      markAreas: [
        { y0: 100, y1: 105, label: "SSR Zone", color: "rgba(255,46,136,0.08)" }
      ],
      markPoints: [
     ...
     ═══════════════════════════════════════════════════════════════════════ */
  {
    ...
    introChart: {
      ...
      markAreas: [
        { y0: 83, y1: 88, label: "Range Low — Demand / Support",  color: "rgba(0,212,212,0.07)" },
        { y0: 93, y1: 98, label: "Range High — Supply / Resistance", color: "rgba(255,46,136,0.07)" }
      ],
      markLines: [
        { yAxis: 90.5, label: "Midpoint (Fib 50%) — Chop Zone, Avoid", color: "#ffcc00" }
      ],
      markPoints: [
        { dataIndex:  4, label: "Low — Touch 1 (best entry)",  position: "bottom" },
    ...
    quiz: {
      ...
      revealMarkPoints: [
        ...
        { dataIndex: 20, label: "Touch 5 = Breakout! Buy, Don't Short!", position: "top", color: "#ff2e88" }
      ],
...
const LT_EXAM_QUESTIONS_3 = [
  ...
  { chapterTitle: 'Identifying Access Points',
    ...
    chart: { type:'candlestick', labels: ltLabels(14),
      ...
      markLines: [{ yAxis: 100.5, label: 'Resistance', color: '#ff2e88' }] },
    answers: [
  ...
  { chapterTitle: 'Leverage Done Right',
    ...
    chart: { type:'candlestick', labels: ltLabels(11),
      ...
      markLines: [
        ...
        { yAxis: 92,  label: 'Liquidation 92',  color: '#ff2e88' } ] },
    answers: [
