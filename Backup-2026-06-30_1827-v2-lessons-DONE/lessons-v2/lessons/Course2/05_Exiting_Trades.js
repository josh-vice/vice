...
(window.LT_LESSONS = window.LT_LESSONS || {})['course2/05_exiting_trades'] = {
  ...
  beats: [
    ...
    },
    {
      ...
      show: [ { kind: 'level', at: 'stop', side: 'left', label: 'stop — the other order that can fill' },
        { kind: 'level',  at: 'target', label: 'take-profit — limit sell at resistance', side: 'left' },
        { kind: 'marker', at: 'target', label: 'order fills — booked', style: 'reversal', place: 'above' }
      ]
    },
    {
      id: 'trailing',
      ...
      say: "The second approach is the trailing stop. Instead of a fixed target, you move your stop up behind price as it makes each new higher low. You lock in profit at every step and stay in the trade as long as the trend holds. Trailed well, this can capture a much larger R-multiple by riding a breakout to its end.",
      show: [
