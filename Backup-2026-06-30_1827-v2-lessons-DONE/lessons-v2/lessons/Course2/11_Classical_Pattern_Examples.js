...
(window.LT_LESSONS = window.LT_LESSONS || {})['course2/11_classical_pattern_examples'] = {
  ...
  beats: [
    ...
    },
    {
      ...
      show: [ { kind: 'marker', at: 'flagB', style: 'dot', place: 'below', label: 'stop below flag' },
    ...
    },
    {
      ...
      show: [ { kind: 'marker', at: 'rightShoulder', style: 'dot', place: 'above', label: 'stop above right shoulder' },
