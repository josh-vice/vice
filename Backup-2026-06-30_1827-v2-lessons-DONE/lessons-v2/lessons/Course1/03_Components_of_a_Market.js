...
(window.LT_LESSONS = window.LT_LESSONS || {})['course1/03_components_of_a_market'] = {
  ...
  beats: [
    ...
    },
    {
      ...
      show: [
        { kind: 'level', at: 'high', label: 'Supply — sellers', side: 'left' },
        { kind: 'level', at: 'low',  label: 'Demand — buyers',  side: 'left' },
        { kind: 'zone',  side: 'below', of: 'high', label: 'supply zone — sellers step in' },
        { kind: 'zone',  side: 'above', of: 'low',  label: 'demand zone — buyers step in' }
      ]
    },
    {
      id: 'demand-bounce',
    ...
    },
    {
      ...
      say: "But here's the crucial part: there are only so many buyers and sellers. A demand zone holds and holds — until the buyers are used up. With no one left to defend it, price breaks down through the zone. The same is true of supply: exhaust the sellers and price breaks out. Recognising when a zone is running out is what the rest of the course is about.",
      show: [ { kind: 'level', at: 'rangeHigh', side: 'left', label: 'supply zone' },
        { kind: 'level',  at: 'rangeLow', label: 'demand zone', side: 'left' },
    ...
    },
    {
      id: 'recap',
      type: 'CONCEPT',
      say: "To recap: supply and demand is just the conversation between buyers and sellers, drawn on the chart. We mark the zones where each side shows up, we watch for the exhaustion of one side, and we remember that every zone is finite. And this is the foundation of the next idea — supply and demand is what support and resistance is built from.",
      panel: {
