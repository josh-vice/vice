...
(window.LT_LESSONS = window.LT_LESSONS || {})['course4/22_positions_heatmap'] = {
  ...
  beats: [
    ...
    },
    {
      ...
      show: [ { kind: 'marker', at: 'reversal', style: 'reversal', place: 'above', label: 'sweep & reverse' },
        { kind: 'zone',  side: 'above', of: 'clusterHi', depth: 5, label: 'hot band — densest liquidations' },
        { kind: 'level', at: 'clusterHi', label: 'magnet', side: 'left' },
        { kind: 'zone',  side: 'below', of: 'clusterLo', depth: 3, label: 'lighter band' },
