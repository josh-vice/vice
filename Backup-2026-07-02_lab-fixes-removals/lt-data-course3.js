...
const LT_EXAM_QUESTIONS_3 = [
  ...
  { chapterTitle: 'Identifying Access Points',
    ...
    chart: { type:'candlestick', labels: ltLabels(13),
      // Price taps and REJECTS the 101 resistance several times (upper wicks) before coiling
      // just beneath it — so the level is earned, not a line above an untouched drift.
      ohlc: ltCandles(80, [{ to:101, bars:5, reject:1.2 }, { to:99, bars:2 }, { to:101, bars:2, reject:0.9 }, { to:99, bars:2 }, { to:100.4, bars:2 }], { seed: 342, wick: 0.28 }),
  ...
  { chapterTitle: 'Developing a Trader’s Mindset',
    question: 'In the course’s edge taxonomy, a discretionary edge is:',
    answers: [
      { id:'a', text:'Observation-based — e.g. noticing that CME gaps on BTC futures consistently fill', correct:true },
      { id:'b', text:'A fixed parameter formula, like a position-sizing equation', correct:false },
      { id:'c', text:'A guarantee of returns that never needs iteration', correct:false },
      { id:'d', text:'Whatever other traders on social media agree on', correct:false } ] },

  { chapterTitle: 'Trading Full-Time',
    question: 'The typical evolution of a full-time trader runs:',
    answers: [
      { id:'a', text:'Big losses → small losses → break-even → profitability, built over years of journaling and discipline', correct:true },
      { id:'b', text:'Straight to consistent profits if the system is good enough', correct:false },
      { id:'c', text:'From profitability back to big losses as edges are found instantly', correct:false },
      { id:'d', text:'However each trader wants — there is no common path', correct:false } ] },
