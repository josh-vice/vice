...
const LT_CHAPTERS_4 = [
     ...
     ═══════════════════════════════════════════════════════════════════════ */
  {
    ...
    demo: {
      ...
      bullets: [
        "A single signal alone is only a hint — <strong>all four at once</strong>, at a key level, is high-conviction signal",
        "Crowded shorts (negative funding + rising OI + red delta + backwardation) at support = fuel for a squeeze UP",
        "The conviction meter is the whole point: conviction rises as more variables align",
