  ...
  beats: [
    ...
    },
    {
      ...
      show: [
        ...
        { kind: 'marker', at: 'test1', label: 'prior reaction', style: 'dot', place: 'above' },
        { kind: 'marker', at: 'test2', label: 'prior reaction', style: 'dot', place: 'above' },
    ...
    },
    {
      ...
      show: [ { kind: 'zone', of: 'level', side: 'below', tone: 'risk', label: 'risk defined under level' },
        { kind: 'zone', of: 'level', side: 'above', tone: 'reward', label: 'reward — target zone' },
        { kind: 'marker', at: 'entry', label: 'first test of S/R flip — long', style: 'reversal', place: 'below' },
        { kind: 'level',  at: 'target', label: 'take-profit target', side: 'right' }
      ]
    },
    {
      id: 'confirm',
      ...
      show: [
        { kind: 'level',  at: 'support', label: 'the level', side: 'left', tone: 'reward' },
    ...
    },
    {
      id: 'finite',
      type: 'CONCEPT',
      say: "Two rules to carry out of this. At demand and support, look to buy; at supply and resistance, look to sell. You'll hear us call these zones DBS and SSR — demand, buyers, support; and supply, sellers, resistance. It works short too: when support breaks down it becomes resistance, and the retest from below is the short. Zones are finite — the first clean test is the best one to trade.",
      panel: {
