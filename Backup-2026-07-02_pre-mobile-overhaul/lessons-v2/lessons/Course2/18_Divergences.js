...
(window.LT_LESSONS = window.LT_LESSONS || {})['course2/18_divergences'] = {
  ...
  beats: [
    ...
    },
    {
      ...
      say: "Here's the classic case. Price grinds out a higher high, the second peak above the first. But look at the RSI below: its second peak is lower than the first. Price up, momentum down. That's a regular bearish divergence — buyers exhausting, warning of a reversal down. Connect tops to tops, and notice the slopes disagree; that's what makes it valid.",
    ...
    },
    {
      id: 'four-setups',
      type: 'CONCEPT',
      say: "The four setups. Regular bullish: price lower low, oscillator higher low — seller exhaustion, reversal up, found at bottoms. Regular bearish: price higher high, oscillator lower high — buyer exhaustion, reversal down, at tops. Hidden bullish: price higher low, oscillator lower low — buyers re-entering, continuation up. Hidden bearish: price lower high, oscillator higher high — sellers re-entering, continuation down.",
      panel: {
    ...
    },
    {
      id: 'rules',
      type: 'CONCEPT',
      say: "A few rules to keep you safe. Trade divergences with the higher-time-frame trend — don't hunt hidden bearish setups in a macro uptrend. Wait for the oscillator to cross back out of overbought or oversold into the midrange before acting. And never trade a divergence alone: it's strongest on a key S/R zone with a candlestick trigger. A leading clue, not a guarantee.",
      panel: {
