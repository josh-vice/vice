...
(window.LT_LESSONS = window.LT_LESSONS || {})['course2/13_ichimoku_kinko_hyo'] = {
  ...
  beats: [
    ...
    },
    {
      id: 'components',
      type: 'CONCEPT',
      say: "Ichimoku has five components. The Tenkan-sen, or conversion line, is a fast average; the Kijun-sen, or base line, a slower one. Senkou Span A and B project forward and form the Kumo cloud. The Chikou span is the current price plotted back in time — clear of the old price means trending, buried inside it means ranging. And its moving averages use the period's high-plus-low midpoint, not the close.",
      panel: {
        ...
        lines: [
          ...
          '**Chikou** — the lagging span: price plotted back; clear of price = trending, inside = ranging',
          'Its moving averages use **(high + low) / 2**, not the close'
        ]
      }
    },
    {
