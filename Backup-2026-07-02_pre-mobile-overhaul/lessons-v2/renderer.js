...
(function (g) {
  ...
  LTRenderer.prototype._build = function (mount) {
    ...
    this.panel.innerHTML = '<div class="ltp2-pmark" aria-hidden="true">' + ICON_CONCEPT + '</div>' +
      '<div class="ltp2-kicker"></div><div class="ltp2-title"></div><ul class="ltp2-lines"></ul><div class="ltp2-quad"></div>';
...
<div class="ltp2-complete-title"></div>\
  ...
  LTRenderer.prototype._anno = function (P, an, av) {
    ...
    if (an.kind === 'level') {
      ...
      if (an.label) {
        ctx.font = (tight ? '700 10px' : '700 11px') + ' Cascadia Code, JetBrains Mono, monospace';
      ...
      if (an.label) {
        ...
        ctx.font = (tight ? '700 9px' : '700 10px') + ' Cascadia Code, JetBrains Mono, monospace';
      ...
      ctx.globalAlpha = av;
      if (an.label) {
        ctx.fillStyle = C.ink; ctx.font = (tight ? '9px' : '10px') + ' Cascadia Code, JetBrains Mono, monospace';
        ctx.textAlign = 'left'; ctx.textBaseline = 'middle';
