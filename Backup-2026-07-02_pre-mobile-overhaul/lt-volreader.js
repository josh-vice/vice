...
(function () {
  ...
  function _vrStyles() {
    LTUtils.injectStyles('lt-volreader-styles', [
      ".vr-wrap{width:100%;max-width:560px;margin:0 auto;font-family:'Cascadia Code','JetBrains Mono',ui-monospace,monospace;color:var(--text,#f6f5fb);}",
  ...
  function _sceneSvg(sc) {
    ...
    return '<svg viewBox="0 0 ' + W + ' ' + H + '" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Price and volume panels">'
      ...
      + '<text x="' + PAD_L + '" y="' + (vTop + 2) + '" fill="' + S + '" font-size="8.5" letter-spacing="1" font-family="JetBrains Mono,monospace">VOLUME</text>'
      + body
      + '</svg>';
  }
