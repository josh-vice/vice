...
function renderSettingsPage(containerId) {
  ...
  wrap.innerHTML =
    ...
    '<div class="lt-settings-section" id="lt-s-study">' +
      ...
      '<div class="lt-settings-row">' +
        '<div class="lt-settings-row-info">' +
          '<div class="lt-settings-row-label">Final Exam Answer Key</div>' +
          '<div class="lt-settings-row-desc">Review all 60 final-exam questions and their correct answers (the 15 hardest per course)</div>' +
        '</div>' +
        '<div class="lt-settings-row-control">' +
