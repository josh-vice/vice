...
const LT_CHAPTERS_2 = [
     ...
     ═══════════════════════════════════════════════════════════════════════ */
  {
    ...
    lessonChart: {
      ...
      markLines: [ { yAxis: 82, label: "Stop — below swing low", color: "#ff2e88" }, { yAxis: 93, label: "Target — exit at SSR", color: "#00d4d4" } ],
      type: "candlestick",
      labels: ltLabels(18),
      ohlc: ltCandles(93, [
        { to: 84, bars: 3 },
    ...
    quiz: {
      ...
      revealMarkPoints: [ { dataIndex: 9, label: "Stop — below swing low", position: "bottom", color: "#ff2e88" }, { dataIndex: 14, label: "Target — SSR", position: "top", color: "#00d4d4" },
     ...
     ═══════════════════════════════════════════════════════════════════════ */
  {
    ...
    introChart: {
      ...
      markLines: [ { yAxis: 97, label: "Stop — below swing low", color: "#ff2e88" }, { yAxis: 111, label: "Target — next resistance", color: "#ffcc00" },
    ...
    lessonChart: {
      ...
      markLines: [ { yAxis: 83, label: "Stop — below swing low", color: "#ff2e88" } ],
      type: "candlestick",
      labels: ltLabels(16),
      ohlc: ltCandles(93, [
        { to: 84, bars: 4 },
    ...
    quiz: {
      ...
      revealMarkPoints: [ { dataIndex: 14, label: "Target — next resistance", position: "top", color: "#ffcc00" },
     ...
     ═══════════════════════════════════════════════════════════════════════ */
  {
    ...
    lessonChart: {
      ...
      markLines: [ { yAxis: 103, label: "Invalidation / Stop — below flip", color: "#ff2e88" }, { yAxis: 111, label: "First Barrier (FB)", color: "#ff2e88" },
     ...
     ═══════════════════════════════════════════════════════════════════════ */
  {
    ...
    introChart: {
      ...
      markLines: [ { yAxis: 110, label: "Final Trail Stop", color: "#ff2e88" },
     ...
     ═══════════════════════════════════════════════════════════════════════ */
  {
    ...
    introChart: {
      ...
      markAreas: [
        ...
        { y0: 98, y1: 103,label: "Resistance Zone", color: "rgba(255,46,136,0.07)"  }
      ],
      markPoints: [
     ...
     ═══════════════════════════════════════════════════════════════════════ */
  {
    ...
    lessonChart: {
      ...
      markPoints: [ { dataIndex: 8, label: "Short Entry Trigger", position: "bottom", color: "#ff2e88" },
     ...
     ═══════════════════════════════════════════════════════════════════════ */
  {
    ...
    lessonChart: {
      ...
      markAreas: [ { y0: 87, y1: 92, label: "Coiling Range", color: "rgba(0,212,212,0.07)" },
     ...
     ═══════════════════════════════════════════════════════════════════════ */
  {
    ...
    lessonChart: {
      ...
      markPoints: [ { dataIndex: 7, label: "Morning Star", position: "bottom", color: "#00d4d4" },
     ...
     ═══════════════════════════════════════════════════════════════════════ */
  {
    ...
    introChart: {
      ...
      markLines: [ { yAxis: 112, label: "Target = Pole Height", color: "#00d4d4" } ],
      type: "candlestick",
      chartHeight: 440,
      volume: { profile: "pattern" },
      chartHeight: 480,
     ...
     ═══════════════════════════════════════════════════════════════════════ */
  {
    ...
    introChart: {
      ...
      markLines: [ { yAxis: 103, label: "Stop — Above Flag High", color: "#ff2e88" }, { yAxis: 78, label: "Target — Pole Distance", color: "#ffcc00" },
        { yAxis: 99, label: "Flag Resistance (Level)", color: "#ff2e88" }
      ],
      markAreas: [
        { y0: 97, y1: 102, label: "Level Zone", color: "rgba(255,46,136,0.06)" }
      ],
      markPoints: [
     ...
     ═══════════════════════════════════════════════════════════════════════ */
  {
    ...
    lessonChart: {
      ...
      markLines: [ { yAxis: 88, label: "Kijun — Trailing Stop", color: "#ff2e88" },],
      markAreas: [],
      markPoints: [
    ...
    quiz: {
      ...
      chart: {
        ...
        markLines: [
          { yAxis: 85, label: "Kijun-sen", color: "#ff2e88" }
        ],
        markAreas: [
     ...
     ═══════════════════════════════════════════════════════════════════════ */
  {
    ...
    introChart: {
      ...
      markLines: [
        { yAxis: 86, label: "Kijun-sen", color: "#ff2e88" }
      ],
      markAreas: [
    ...
    lessonChart: {
      ...
      markLines: [ { yAxis: 113, label: "Kijun-sen (trailing stop)", color: "#ff2e88" },
        { yAxis: 85, label: "Entry",        color: "#00d4d4" },
        { yAxis: 82, label: "Initial Stop", color: "#ff2e88" }
      ],
      markPoints: [
    ...
    quiz: {
      ...
      chart: {
        ...
        markLines: [
          { yAxis: 88, label: "Kijun-sen",  color: "#ff2e88" },
...
const LT_EXAM_QUESTIONS_2 = [
  ...
  { chapterTitle: 'Classical Chart Patterns',
    ...
    chart: { type:'candlestick', labels: ltLabels(10),
      ...
      markLines: [{ yAxis: 100, label: 'Resistance', color: '#ff2e88' }] },
    answers: [
