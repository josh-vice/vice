  ...
  beats: [
    ...
    },
    {
      ...
      show: [
        ...
        { kind: 'marker', at: 'touch2', label: '', style: 'reversal', place: 'below' },
        { kind: 'marker', at: 'touch3', label: '', style: 'reversal', place: 'below' }
      ]
    },
    {
      ...
      show: [
        ...
        { kind: 'marker', at: 'touch3', label: '', style: 'dot', place: 'above' }
      ]
    },
    {
      id: 'horizontal',
      ...
      show: [
        { kind: 'level',  at: 'level', label: 'horizontal support', side: 'left' },
