  ...
  beats: [
    ...
    },
    {
      ...
      show: [
        ...
        { kind: 'marker', at: 'magnet', label: 'cascade spikes into the cluster', style: 'sweep', place: 'above' }
      ]
    },
    {
      id: 'reversal',
      ...
      show: [
        { kind: 'marker', at: 'magnet', label: 'liquidity consumed', style: 'sweep', place: 'above' },
        { kind: 'marker', at: 'reversal', label: 'no fuel left → reverse (short)', style: 'reversal', place: 'below' },
        { kind: 'level',  at: 'clusterLo', label: 'next target', side: 'left' }
      ]
    },
    {
      id: 'recap',
