...
const LT_CHAPTERS_4 = [
     ...
     ═══════════════════════════════════════════════════════════════════════ */
  {
    ...
    introChart: {
      ...
      // The 4/4 scorecard lives on the confluence band label; only the DRAWN funding series
      // is pinned so no undrawn variable sits on a bare candle (OI/CVD/basis each have their
      // own chapter — the engine renders one sub-panel, funding, here)
      markAreas: [
        { y0: 76, y1: 81, label: "4/4 SA aligned: Funding ✓ OI ✓ Δ ✓ Basis ✓", color: "rgba(0,212,212,0.08)" }
      ],
      // SA Check 1 drawn — funding extreme negative into the DBS, crossing zero on the squeeze
      subPanel: { kind: "funding", label: "Funding Rate (SA 1/4 shown)", points: [[0,-0.02],[7,-0.085],[9,-0.07],[11,0],[15,0.024]] },
      markPoints: [
