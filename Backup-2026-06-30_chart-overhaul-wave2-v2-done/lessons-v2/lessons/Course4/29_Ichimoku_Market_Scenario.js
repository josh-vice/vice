  ...
  beats: [
    ...
    },
    {
      ...
      show: [
        ...
        { kind: 'marker', at: 'tkCross', label: 'Tenkan crosses above Kijun → momentum up', style: 'reversal', place: 'below' }
      ]
    },
    {
      id: 'entry',
      ...
      show: [
        { kind: 'level', at: 'kijunLevel', label: 'Kijun — dynamic support', side: 'left', tone: 'support' },
        { kind: 'note',  at: 'pullback', label: 'pullback to Kijun = entry', place: 'below' },
        { kind: 'level', at: 'stop', label: 'risk just below the cloud', side: 'right', tone: 'stop' },
