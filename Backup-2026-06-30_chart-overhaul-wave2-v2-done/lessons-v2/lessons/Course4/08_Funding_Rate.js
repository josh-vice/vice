...
(window.LT_LESSONS = window.LT_LESSONS || {})['course4/08_funding_rate'] = {
  ...
  beats: [
    ...
    },
    {
      ...
      show: [
        { kind: 'marker', at: 'rising', label: 'funding climbing into positive', style: 'dot', place: 'above' },
        { kind: 'marker', at: 'top', label: 'funding extreme — longs crowded & offside', style: 'dot', place: 'above' },
        { kind: 'marker', at: 'flip', label: 'longs squeezed → funding flips negative', style: 'sweep', place: 'below' }
      ]
    },
    {
      id: 'offside',
