...
(window.LT_LESSONS = window.LT_LESSONS || {})['course4/09_open_interest'] = {
  ...
  beats: [
    ...
    },
    {
      ...
      show: [
        { kind: 'marker', at: 'rising', label: 'OI rising with trend = new money', style: 'dot', place: 'above' },
        { kind: 'marker', at: 'top', label: 'high OI = positions stacked (fuel)', style: 'dot', place: 'above' },
        { kind: 'marker', at: 'reversal', label: 'OI falls = positions close / liquidate', style: 'sweep', place: 'below' }
      ]
    },
    {
      id: 'rules',
