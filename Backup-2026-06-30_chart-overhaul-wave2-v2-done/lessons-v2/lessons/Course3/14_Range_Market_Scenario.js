  ...
  beats: [
    ...
    },
    {
      ...
      show: [
        ...
        { kind: 'zone',  side: 'below', of: 'high', tone: 'risk',   label: 'supply' },
    ...
    },
    {
      ...
      show: [
        { kind: 'level',  at: 'support', label: 'range low', side: 'left', tone: 'support' },
        { kind: 'marker', at: 'firstTest', label: 'prior test — level holds', style: 'dot', place: 'below' },
        { kind: 'marker', at: 'sweepLow', label: 'deviation below — sellers trapped', style: 'sweep', place: 'below' },
    ...
    },
    {
      ...
      show: [ { kind: 'level', at: 'rangeLow', side: 'left', label: 'range low', tone: 'support' },
