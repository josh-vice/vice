...
- `Backup-2026-06-17_1602-audit-fixes/` — **latest** (code only; audio regenerable). Snapshot BEFORE the
  trader-audit fixes (`later⁹`). Cache at that point: `lt-engine.js 3.103.0`, `lt-chartgen.js 1.1.0`,
  `lt-data-course2.js 1.7.1`, `lt-data-course4.js 1.13.0`, `lt-data-course3.js 1.9.0`. **After this session:**
  `lt-engine.js 3.104.0`, `lt-data-course2.js 1.8.0`, `lt-data-course4.js 1.14.1` (chartgen 1.1.0, course3 1.9.0
  unchanged; other files: `lt-styles.css 1.98.3`, `lessons-v2/renderer.js 1.13.0`, `lt-glossary.js 1.19.0`, …).
