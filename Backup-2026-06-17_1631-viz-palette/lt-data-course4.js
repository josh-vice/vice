...
const LT_CHAPTERS_4 = [
     ...
     ═══════════════════════════════════════════════════════════════════════ */
  {
    ...
    lessonChart: {
      ...
      liqCluster: { lines: [104.5, 106, 107.5], label: "Short Stop Cluster (SFP)", color: "#cc2222" },
      markPoints: [
    ...
    quiz: {
      ...
      chart: {
        ...
        liqCluster: { lines: [104.5, 106, 107.5], label: "Short Stop Cluster", color: "#cc2222" }
      },
      revealMarkPoints: [
     ...
     ═══════════════════════════════════════════════════════════════════════ */
  {
    ...
    lessonChart: {
      ...
      markLines: [
        { yAxis: 62, label: "Stop Loss — Below Cloud",        color: "#cc2222" },
    ...
    quiz: {
      ...
      chart: {
        ...
        markLines: [
          ...
          { yAxis: 86, label: "Top Edge — E2E Target",  color: "#ffcc00" }
        ]
      },
      revealMarkPoints: [
