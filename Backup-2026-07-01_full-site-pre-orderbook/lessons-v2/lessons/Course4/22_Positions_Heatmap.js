...
(window.LT_LESSONS = window.LT_LESSONS || {})['course4/22_positions_heatmap'] = {
  ...
  beats: [
    ...
    },
    {
      ...
      show: [ { kind: 'heatmap', of: 'stop', to: 'bandHi', tone: 'short', peak: 0.8, label: 'hot band — brightest = densest' },
        { kind: 'level', at: 'clusterHi', label: 'magnet', side: 'left' },
        { kind: 'heatmap', of: 'bandLo', to: 'bandLo2', tone: 'long', peak: 0.15, intensity: 0.5, label: 'lighter band below' },
