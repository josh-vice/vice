...
(window.LT_LESSONS = window.LT_LESSONS || {})['course4/11_future_basis'] = {
  ...
  beats: [
    ...
    },
    {
      ...
      show: [
        { kind: 'marker', at: 'top', label: 'premium extreme — longs over-eager', style: 'reversal', place: 'above', panel: 'sub' },
        { kind: 'marker', at: 'rejection', label: 'rejection — premium collapse begins', style: 'sweep', place: 'above', panel: 'sub' },
        { kind: 'marker', at: 'discount', label: 'basis crosses into discount', style: 'sweep', place: 'below', panel: 'sub' }
      ]
    },
    {
      id: 'recap',
