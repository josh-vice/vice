...
(window.LT_LESSONS = window.LT_LESSONS || {})['course2/11_classical_pattern_examples'] = {
  ...
  beats: [
    ...
    },
    {
      ...
      show: [ { kind: 'level',  at: 'stop', side: 'left', label: 'stop below flag', tone: 'stop' },
        ...
        { kind: 'marker', at: 'retest', label: 'or its retest', style: 'dot', place: 'below' },
    ...
    },
    {
      ...
      show: [ { kind: 'marker', at: 'leftShoulder', style: 'dot', place: 'above', label: 'shoulder' },
        { kind: 'marker', at: 'head', style: 'dot', place: 'above', label: 'head' },
        { kind: 'marker', at: 'rightShoulder', style: 'dot', place: 'above', label: 'shoulder' },
        { kind: 'level',  at: 'stop', label: 'stop above right shoulder', side: 'left', tone: 'stop' },
