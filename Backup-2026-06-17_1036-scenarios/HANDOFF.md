...
- `Backup-2026-06-17_0238-accuracy-player/` — **latest** (code only; audio regenerable). Snapshot taken
  BEFORE the chart-accuracy + player-compaction pass below. Current cache versions: `lt-engine.js 3.100.5`,
  `lt-styles.css 1.98.3`, `lt-settings.js 1.29.0`, `lessons-v2/chart-vocabulary.js 1.1.0`,
  `lessons-v2/renderer.js 1.11.2`, `lessons-v2/player.css 1.7.2`, `lessons-v2/audio/manifest.js 1.1.0`,
