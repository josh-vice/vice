...
- Funded-testnet evidence: `docs/evidence/advanced-order-certification-2026-08-06.json` (15/15 phases, 22 real venue order IDs, 37 observed fills) plus `docs/evidence/trigger-fired-events-2026-08-04.json` (two genuine open→triggered→filled fires) and hermes-sidecar P2 evidence `docs/evidence/hermes-sidecar-p2-2026-08-05.json`.

## Evidence log

- 2026-08-07: Advanced-order certification 15/15 and trigger-lifecycle funded evidence exist; browser restart evidence for every local algorithm remains open (PLAN_3 "Direct and persistent execution" / "Automation persistence disclosure" rows).
