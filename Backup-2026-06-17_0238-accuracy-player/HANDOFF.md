...
- `Backup-2026-06-17_0215-tts/` — **latest** (code only; the ~96MB of generated lesson audio is in
  the working tree and regenerable via `tools/tts/generate.py`). Captures the Kokoro TTS narration
  system + speed/volume/karaoke/quest-complete. Current cache versions: `lt-engine.js 3.100.5`,
  `lt-styles.css 1.98.3`, `lt-settings.js 1.29.0`, `lessons-v2/renderer.js 1.10.0`, `player.css 1.7.0`,
  `lessons-v2/audio/manifest.js 1.1.0`, `lt-module-quizzes.js 1.0.0`.
