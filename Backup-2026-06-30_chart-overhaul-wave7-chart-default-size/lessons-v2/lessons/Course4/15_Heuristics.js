...
(window.LT_LESSONS = window.LT_LESSONS || {})['course4/15_heuristics'] = {
  ...
  beats: [
    ...
    },
    {
      ...
      show: [
        { kind: 'marker', at: 'flipDown1', label: 'colour turns pink — sellers step in', style: 'dot', place: 'above' },
        { kind: 'marker', at: 'flipUp1', label: 'colour turns teal — buyers step in', style: 'dot', place: 'below' }
      ]
    },
    {
      id: 'use',
