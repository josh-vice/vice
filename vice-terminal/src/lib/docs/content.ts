...
const coreTopics: Record<string, DocTopic> = {
	...
	'enable-trading': {
		...
		kicker: 'Setup',
		sections: [
			{ id: 'create-agent', title: 'Create the agent', body: ['Vice generates a new agent key locally and asks the connected master wallet to approve it for the current account and network.'], steps: ['Review the custody disclosure', 'Review the builder fee', 'Approve the agent in your wallet', 'Unlock the encrypted local vault'] },
