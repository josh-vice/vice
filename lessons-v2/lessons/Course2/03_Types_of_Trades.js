...
(window.LT_LESSONS = window.LT_LESSONS || {})['course2/03_types_of_trades'] = {
  ...
  beats: [
    ...
    },
    {
      ...
      show: [ { kind: 'marker', at: 'breakout', style: 'dot', place: 'above', label: 'resistance breaks' },
    ...
    },
    {
      ...
      say: "Now define the trade. Entry at the level. Stop just below it — if price closes under, our thesis is wrong and we're out for a small, known loss. Target at the next key level above. Three prices, chosen before we click a thing.",
      show: [
    ...
    },
    {
      ...
      chart: 'trade_setup_long',
      stage: 'plan',
      heading: 'Know Your Ratio Up Front',
      say: "With the three prices set, the trade becomes arithmetic. Everything from entry down to the stop is our risk; everything from entry up to the target is our reward. Map both zones and you know your risk-to-reward ratio before you ever take the trade — no surprises, no improvising.",
      show: [
    ...
    },
    {
      id: 'recap',
      type: 'CONCEPT',
      say: "That's the whole method, and it scales to any style — position, swing, day, or scalp. Two names to remember: a demand zone at support is a DBS — demand buyer support — and a supply zone at resistance is an SSR — seller supply resistance. And besides trailing your stop behind new higher lows, you can set partial take-profit levels at each resistance on the way up. Next we'll formalise how we enter.",
      panel: {
        title: 'Types of Trades — Recap',
        lines: [
          'Structure → level → plan, for every style',
          '**DBS** = demand buyer support · **SSR** = seller supply resistance',
          'Define entry, stop (invalidation), and target up front',
          '**Trail your stop** behind higher lows, or scale out at **partial TP levels**',
