...
(window.LT_LESSONS = window.LT_LESSONS || {})['course2/01_trading_styles'] = {
  ...
  beats: [
    ...
    },
    {
      id: 'four-styles',
      type: 'CONCEPT',
      say: "There are four. Position trading is high-timeframe macro — holding for months as a trend unfolds. Swing trading is similar but a smaller horizon, working the daily and weekly swing points. Day trading takes a position within the session and closes before it ends, avoiding overnight risk — market hours in traditional markets, while crypto trades 24/7. And scalping is the lowest timeframe — quick trades, often inside ranges, on minutes and hours.",
      panel: {
        title: 'Four Styles, by Timeframe',
        lines: [
          '**Position** — high-timeframe macro, held for months',
          '**Swing** — daily/weekly swing points',
          '**Day** — in and out within one session (crypto runs **24/7**; TradFi keeps market hours)',
    ...
    },
    {
      ...
      show: [ { kind: 'level', at: 'base', side: 'left', label: 'macro support', tone: 'support' },
