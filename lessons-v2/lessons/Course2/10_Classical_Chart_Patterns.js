  ...
  beats: [
    ...
    },
    {
      ...
      show: [
        ...
        { kind: 'marker', at: 'retest', label: 'retest → short', style: 'reversal', place: 'above' },
        { kind: 'level',  at: 'target', label: 'target — wedge height', side: 'right', tone: 'target' }
      ]
    },
    {
      id: 'falling-wedge',
    ...
    },
    {
      ...
      say: "Triangles next. An ascending triangle has a flat top — relatively equal highs — with higher lows pressing up underneath it. Here it resolves upward, but the odds of a breakout versus a breakdown are roughly equal — so wait for the break and a retest before trading it in either direction. The target is the height of the triangle.",
      show: [
        { kind: 'level',  at: 'top', label: 'equal highs (resistance)', side: 'left', tone: 'resistance' },
        ...
        { kind: 'level',  at: 'target', label: 'target — triangle height', side: 'right', tone: 'target' }
      ]
    },
    {
      id: 'desc-triangle',
      ...
      say: "The descending triangle is the mirror: a flat bottom of relatively equal lows, with lower highs pressing down on top. It can be a reversal or a continuation — breakdown and breakout are about equally likely — so once again, let the break happen and wait for a retest before trading it in any direction. The target equals the triangle's height.",
      show: [
        { kind: 'level',  at: 'bottom', label: 'equal lows (support)', side: 'left', tone: 'support' },
    ...
    },
    {
      ...
      show: [
        ...
        { kind: 'trendline', from: 'flagA', to: 'flagB', style: 'resistance', label: 'the flag' },
        { kind: 'marker', at: 'breakout', label: 'continuation', style: 'reversal', place: 'above' },
        { kind: 'level',  at: 'target', label: 'target — pole height', side: 'right', tone: 'target' }
      ]
    },
    {
      id: 'recap',
      ...
      panel: {
        ...
        lines: [
          ...
          'Flags & pennants continue; H&S reverses; wedges — either, by location'
        ]
      }
    }
  ]
