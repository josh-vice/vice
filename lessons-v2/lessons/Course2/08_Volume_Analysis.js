...
(window.LT_LESSONS = window.LT_LESSONS || {})['course2/08_volume_analysis'] = {
  ...
  beats: [
    ...
    },
    {
      ...
      show: [
        { kind: 'marker', at: 'hh2', label: 'rising volume = strong, bullish', style: 'dot', place: 'above' },
        { kind: 'note', at: 'hh2', label: 'bars growing taller', panel: 'sub', place: 'above' }
      ]
    },
    {
      id: 'up-weak',
      ...
      show: [
        ...
        { kind: 'note', at: 'hh2', label: 'bars shrinking', panel: 'sub', place: 'above' }
      ]
    },
    {
      id: 'down-strong',
      ...
      show: [
        { kind: 'marker', at: 'll2', label: 'rising volume = strong selling', style: 'dot', place: 'below' },
        { kind: 'note', at: 'll2', label: 'bars growing taller', panel: 'sub', place: 'above' }
      ]
    },
    {
      id: 'down-weak',
      ...
      show: [
        ...
        { kind: 'note', at: 'll2', label: 'bars drying up', panel: 'sub', place: 'above' }
      ]
    },
    {
      id: 'recap',
