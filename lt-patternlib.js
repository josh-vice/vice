...
(function () {
  ...
  function _tx(x, y, s, c, anc) { return '<text x="' + x + '" y="' + y + '" fill="' + (c || S) + '" font-size="9" font-family="Geist Mono,monospace" font-weight="700" text-anchor="' + (anc || 'start') + '">' + s + '</text>'; }
  ...
  function _plStyles() {
      ...
      ".pl-wrap{width:100%;max-width:860px;margin:0 auto;font-family:'Geist Mono',ui-monospace,monospace;}",
