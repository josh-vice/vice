  ...
  beats: [
    ...
    },
    {
      ...
      show: [ { kind: 'marker', at: 'll1', style: 'dot', place: 'below', label: 'lower low' },
        ...
        { kind: 'marker', at: 'll2', label: 'just the HTF pullback', style: 'sweep', place: 'below' }
      ]
    },
    {
      id: 'entry',
      ...
      show: [ { kind: 'marker', at: 'breakout', style: 'reversal', place: 'above', label: 'reclaims the level' },
        { kind: 'level',  at: 'level', label: 'reclaimed level', side: 'left' },
        { kind: 'marker', at: 'retest', label: 'entry — aligned with HTF', style: 'reversal', place: 'below' }
      ]
    },
    {
      id: 'recap',
