...
- `Backup-2026-06-17_1347-toolviz/` — **latest** (code only; audio regenerable). Snapshot taken BEFORE the
  full Hyblock tool-visualization rollout (`later⁷`). Cache versions at that point: `lt-engine.js 3.101.9`,
  `lt-data-course4.js 1.12.0`, `lt-data-course3.js 1.8.0`. **After this session:** `lt-engine.js 3.102.2`,
  `lt-data-course4.js 1.13.0`, `lt-data-course3.js 1.9.0` (other files unchanged: `lt-styles.css 1.98.3`,
  `lt-settings.js 1.29.0`, `lessons-v2/renderer.js 1.13.0`, `lt-glossary.js 1.19.0`, …).
