...
(window.LT_LESSONS = window.LT_LESSONS || {})['course1/06_rangebound_markets'] = {
  ...
  beats: [
    ...
    },
    {
      ...
      show: [
        { kind: 'level', at: 'high', label: 'Range High — resistance', side: 'left', tone: 'risk' },
        { kind: 'level', at: 'low',  label: 'Range Low — support', side: 'left', tone: 'reward' },
        { kind: 'zone',  side: 'below', of: 'high', tone: 'risk',   label: 'sellers / supply' },
        { kind: 'zone',  side: 'above', of: 'low',  tone: 'reward', label: 'buyers / demand' }
      ]
    },
    {
      id: 'players',
    ...
    },
    {
      ...
      show: [
        ...
        { kind: 'level',  at: 'rangeLow',  label: 'range low',  side: 'left', tone: 'reward' },
        { kind: 'marker', at: 'touchHi1', label: '1', style: 'dot', place: 'above' },
        { kind: 'marker', at: 'touchHi2', label: '2', style: 'dot', place: 'above' },
        { kind: 'marker', at: 'touchHi3', label: '3', style: 'dot', place: 'above' },
        { kind: 'marker', at: 'touchHi4', label: '4', style: 'dot', place: 'above' },
        { kind: 'marker', at: 'entry', label: '5 — sellers exhausted, breakout', style: 'reversal', place: 'above' }
      ]
    },
    {
      id: 'breakdown',
