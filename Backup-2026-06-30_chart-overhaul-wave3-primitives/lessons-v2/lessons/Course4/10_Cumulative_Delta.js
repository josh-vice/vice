...
(window.LT_LESSONS = window.LT_LESSONS || {})['course4/10_cumulative_delta'] = {
  ...
  beats: [
    ...
    },
    {
      ...
      show: [
        { kind: 'marker', at: 'high1', label: 'delta’s higher peak', style: 'dot', place: 'above', panel: 'sub' },
        { kind: 'marker', at: 'top', label: 'delta makes a LOWER high — divergence', style: 'reversal', place: 'above', panel: 'sub' }
      ]
    },
    {
      id: 'reading',
