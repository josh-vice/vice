  ...
  beats: [
    ...
    },
    {
      ...
      show: [
        ...
        { kind: 'marker', at: 'runHigh', label: 'market — fills now at current price', style: 'dot', place: 'above' },
        { kind: 'marker', at: 'dip',     label: 'limit fills at your level', style: 'dot', place: 'below' }
      ]
    },
    {
      id: 'manage',
