...
- `Backup-2026-06-17_1536-realism/` — **latest** (code only; audio regenerable). Snapshot taken BEFORE the
  PA-realism + chart-context pass (`later⁸`). Cache versions at that point: `lt-engine.js 3.102.2`,
  `lt-chartgen.js 1.0.0`, `lt-data-course4.js 1.13.0`, `lt-data-course3.js 1.9.0`. **After this session:**
  `lt-engine.js 3.103.0`, `lt-chartgen.js 1.1.0` (data files unchanged; other files: `lt-styles.css 1.98.3`,
