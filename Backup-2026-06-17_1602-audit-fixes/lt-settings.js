...
function ltApplySavedSettings() {
  ...
  var bearC = localStorage.getItem('lt_bearish_color') || '#ff2e88';
...
function renderSettingsPage(containerId) {
  ...
  var savedBear  = localStorage.getItem('lt_bearish_color') || '#ff2e88';
  var savedTheme = localStorage.getItem('lt_theme') || 'dark';
  var savedFont  = localStorage.getItem('lt_font') || 'default';
  var savedCap   = localStorage.getItem('lt_caption_size') || 'md';
  var narrOn     = localStorage.getItem('lt_narration') !== '0';   // narration default on
  ...
  capBtns.forEach(function(btn) {
    btn.addEventListener('click', function() {
      ...
      btn.classList.add('active');
      localStorage.setItem('lt_caption_size', sz);
  ...
  narrBtns.forEach(function(btn) {
    btn.addEventListener('click', function() {
      ...
      btn.classList.add('active');
      localStorage.setItem('lt_narration', on ? '1' : '0');
    });
  });
  ...
  if (resetAllBtn) resetAllBtn.addEventListener('click', function() {
    _ltConfirmDialog('Reset All Progress',
      ...
      'Yes, Reset All', false, function() {
        var keep = ['lt_theme', 'lt_font', 'lt_caption_size', 'lt_narration', 'lt_bullish_color', 'lt_bearish_color', 'lt_sidebar_collapsed'];
