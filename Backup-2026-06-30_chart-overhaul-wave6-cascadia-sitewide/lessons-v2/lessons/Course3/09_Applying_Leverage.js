...
(window.LT_LESSONS = window.LT_LESSONS || {})['course3/09_applying_leverage'] = {
  ...
  beats: [
    ...
    },
    {
      ...
      show: [ { kind: 'level',  at: 'level', label: 'reclaimed level', side: 'left', tone: 'support' },
        { kind: 'marker', at: 'breakout', style: 'reversal', place: 'below', label: 'trigger = bullish engulfing' },
        { kind: 'marker', at: 'entry', label: 'enter the pullback (higher low)', style: 'reversal', place: 'below' },
        { kind: 'level',  at: 'stop', label: 'stop — below the reclaimed level', side: 'right', tone: 'stop' },
        { kind: 'level',  at: 'target', label: 'target — range high (2.5R)', side: 'right', tone: 'target' }
      ]
    },
    {
      id: 'liquidation',
      ...
      show: [ { kind: 'level', at: 'entry', label: 'entry', side: 'left', tone: 'reward' },
        { kind: 'level',  at: 'stop', label: 'stop', side: 'left', tone: 'stop' },
        { kind: 'level',  at: 'liqDanger', label: 'liquidation — high leverage', side: 'right', tone: 'liq' },
        { kind: 'level',  at: 'liqSafe', label: 'liquidation — low leverage', side: 'right', tone: 'liq' },
        { kind: 'marker', at: 'dip', label: 'the dip', style: 'sweep', place: 'below' },
        { kind: 'marker', at: 'liqFire', label: 'over-leverage liquidated on the wick', style: 'reversal', place: 'below' },
