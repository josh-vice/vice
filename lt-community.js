...
const LT_SOCIAL = {
  ...
  featuredVideo: 'https://www.youtube.com/embed/hbQ6Pvauixs',
  team: [
    { handle: 'Captain_Kole', name: 'Captain Kole', role: 'Co-Founder · Liquidity Theory', url: 'https://x.com/Captain_Kole' },
    { handle: 'MikeBTC',      name: 'Mike BTC',     role: 'Co-Founder · Liquidity Theory', url: 'https://x.com/MikeBTC' }
  ]
};
...
function _commStyles() {
  ...
  .cm-back-btn { display:inline-flex; align-items:center; gap:6px; background:none; border:none; color:var(--teal); font-family:'Barlow',sans-serif; font-size:13px; font-weight:600; cursor:pointer; padding:0; }
  ...
  .cm-hero { position:relative; overflow:hidden; border:1px solid var(--border); border-radius:var(--radius-lg);
    background:radial-gradient(120% 140% at 0% 0%, rgba(0,212,212,.14), transparent 55%), var(--bg3);
    padding:30px 30px 28px; margin:8px 0 18px; }
  .cm-hero-eyebrow { font-size:11px; font-weight:700; letter-spacing:1.5px; text-transform:uppercase; color:var(--teal); margin-bottom:8px; }
  .cm-hero-title { font-family:'Barlow Condensed',sans-serif; font-size:42px; font-weight:800; line-height:1; color:var(--text); margin-bottom:12px; }
  .cm-hero-title span { color:var(--teal); }
  .cm-hero-body { font-size:14px; line-height:1.75; color:var(--text2); max-width:680px; }

  .cm-section-label { font-family:'Barlow Condensed',sans-serif; font-size:13px; font-weight:700; text-transform:uppercase; letter-spacing:1.2px; color:var(--text3); margin:26px 0 12px; }
  ...
  .cm-discord-btn { display:inline-flex; align-items:center; gap:8px; background:#5865F2; color:#fff; font-family:'Barlow',sans-serif; font-weight:700; font-size:14px; text-decoration:none; padding:12px 22px; border-radius:var(--radius); transition:all .15s; white-space:nowrap; }
  ...
  .cm-card { display:flex; align-items:center; gap:16px; background:var(--bg3); border:1px solid var(--border); border-radius:var(--radius-lg); padding:18px 20px; transition:all .15s; }
  ...
  .cm-avatar-fallback { width:62px; height:62px; border-radius:50%; flex-shrink:0; display:flex; align-items:center; justify-content:center;
    background:linear-gradient(135deg,var(--teal),#0a8a8a); color:#04201f; font-family:'Barlow Condensed',sans-serif; font-weight:800; font-size:24px; border:2px solid var(--border2); }
  ...
  .cm-x-btn { display:inline-flex; align-items:center; gap:6px; background:#000; border:1px solid var(--border3); color:#fff; font-family:'Barlow',sans-serif; font-weight:700; font-size:12px; text-decoration:none; padding:8px 14px; border-radius:var(--radius); transition:all .15s; white-space:nowrap; }
  .cm-x-btn:hover { background:#1a1a1a; border-color:var(--teal); }

  /* youtube */
  .cm-yt { border:1px solid var(--border); border-radius:var(--radius-lg); overflow:hidden; background:var(--bg3); }
  .cm-yt-head { display:flex; align-items:center; gap:16px; padding:18px 20px; flex-wrap:wrap; }
  .cm-yt-icon { width:50px; height:50px; border-radius:13px; background:#FF0000; display:flex; align-items:center; justify-content:center; flex-shrink:0; }
  .cm-yt-info { flex:1; min-width:200px; }
  .cm-yt-info h3 { font-size:17px; font-weight:800; color:var(--text); margin:0 0 4px; }
  .cm-yt-info p { font-size:13px; color:var(--text2); margin:0; line-height:1.6; }
  .cm-yt-btn { display:inline-flex; align-items:center; gap:7px; background:#FF0000; color:#fff; font-family:'Barlow',sans-serif; font-weight:700; font-size:13px; text-decoration:none; padding:10px 18px; border-radius:var(--radius); transition:all .15s; white-space:nowrap; }
  .cm-yt-btn:hover { background:#cc0000; }
  .cm-yt-video { position:relative; width:100%; aspect-ratio:16/9; border-top:1px solid var(--border); background:#000; }
  .cm-yt-video iframe { position:absolute; inset:0; width:100%; height:100%; border:0; }
  ...
  .cm-blofin-word { font-family:'Barlow Condensed',sans-serif; font-size:28px; font-weight:800; color:#ff6a1a; letter-spacing:.3px; }
  ...
  .cm-blofin-btn { display:inline-flex; align-items:center; gap:8px; background:linear-gradient(110deg,#ff7a2e,#ff5c00); color:#1a0f04;
    font-family:'Barlow',sans-serif; font-weight:800; font-size:14px; text-decoration:none; padding:12px 22px; border-radius:var(--radius); transition:all .15s; white-space:nowrap; }
    ...
    <div class="cm-wrap">
      ...
      <div class="cm-discord">
        ...
        <div class="cm-discord-info">
          <h3>The Liquidity Theory Discord</h3>
      ...
      <!-- BloFin — Trade With Us -->
      <div class="cm-section-label">Trade With Us</div>
      <div class="cm-blofin">
        ...
        <div class="cm-blofin-info">
          <h3>Trade With Us on BloFin</h3>
          <p>Sign up through our referral link to unlock special deals &amp; promotions — and directly support everything we build here.</p>
          <div class="cm-blofin-perks">
            <span class="cm-blofin-perk">Fee discounts</span>
            <span class="cm-blofin-perk">Deposit bonuses</span>
            <span class="cm-blofin-perk">Copy trading</span>
        ...
        <a class="cm-blofin-btn" href="${LT_SOCIAL.blofin}" target="_blank" rel="noopener noreferrer">
          <i data-lucide="trending-up" style="width:16px;height:16px;"></i> Sign Up &amp; Claim Perks
        </a>
      </div>
      ...
      <div class="cm-yt">
        <div class="cm-yt-head">
          ...
          <div class="cm-yt-info">
            ...
            <p>Full lesson breakdowns, market analysis and trade reviews. Every course video lives here — subscribe so you never miss an upload.</p>
          </div>
          <a class="cm-yt-btn" href="${LT_SOCIAL.youtube}" target="_blank" rel="noopener noreferrer">
            <i data-lucide="youtube" style="width:16px;height:16px;"></i> Visit the Channel
          </a>
        </div>
        <div class="cm-yt-video">
          <iframe src="${LT_SOCIAL.featuredVideo}" title="Liquidity Theory — Featured Lesson"
