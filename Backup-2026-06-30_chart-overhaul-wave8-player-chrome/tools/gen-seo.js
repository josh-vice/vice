  ...
  courses.forEach((chapters, ci) => {
    ...
    const lessons = chapters.map((ch, idx) => {
      ...
      return {
        ...
        appLink: `/lt-index.html?c=${courseNum}&ch=${idx}&s=0`
      };
    });
...
<link href="https://fonts.googleapis.com/css2?family=Barlow+Condensed:wght@600;700;800&family=JetBrains+Mono:wght@400;500;600;700&display=swap" rel="stylesheet" />
${extraJsonLd ? `<script type="application/ld+json">${JSON.stringify(extraJsonLd)}</script>` : ''}
<style>
  :root{--bg:#000;--bg3:#0f0f0f;--bg4:#141414;--border:#1e1e1e;--border2:#2a2a2a;--teal:#00d4d4;--text:#fff;--text2:#9aa0a6;--text3:#6b7177;}
  *{box-sizing:border-box;margin:0;padding:0;}
  body{background:var(--bg);color:var(--text);font-family:'JetBrains Mono',ui-monospace,monospace;line-height:1.7;
  ...
  h1,h2,h3{font-family:'Barlow Condensed',sans-serif;letter-spacing:-.2px;line-height:1.15;}
  .brand{display:flex;align-items:center;gap:9px;font-family:'Barlow Condensed',sans-serif;font-weight:800;font-size:20px;margin-bottom:20px;}
  ...
  h1.title{font-size:34px;font-weight:800;margin-bottom:18px;}
  section{background:var(--bg3);border:1px solid var(--border);border-radius:8px;padding:20px 22px;margin-bottom:16px;}
  section h2{font-size:21px;font-weight:800;margin-bottom:10px;}
...
<body>
  <div class="wrap">
    ...
    <a class="cta" href="/lt-index.html">Open the interactive app →</a>
