...
function _fcStyles() {
  ...
  /* Study stage — fills the height left under the control deck and centres the
     card so it reads as the focal point instead of floating in an empty void. */
  .fc-stage { flex:1 1 auto; display:flex; flex-direction:column; justify-content:center; gap:16px; padding:16px 0; }
  /* Plain header (not sticky), left-aligned. */
  .fc-head { margin:0 0 16px; }
  .fc-back-btn { display:inline-flex; align-items:center; gap:6px; background:none; border:none; color:var(--teal); font-family:'JetBrains Mono',monospace; font-size:13px; font-weight:600; cursor:pointer; padding:0; margin-bottom:12px; }
  .fc-back-btn:hover { opacity:.8; }
  .fc-title { font-family:'JetBrains Mono',monospace; font-size:21px; letter-spacing:-0.5px; font-weight:800; color:var(--text); line-height:1.15; }
  ...
  .fc-mode-btn { padding:5px 12px; border:none; background:none; color:var(--text3); font-size:12px; font-weight:700; cursor:pointer; font-family:'JetBrains Mono',monospace; border-radius:6px; transition:all .12s; white-space:nowrap; }
  .fc-mode-btn.active { background:color-mix(in srgb, var(--fc-accent,var(--teal)) 15%, transparent); color:var(--fc-accent,var(--teal)); }
  .fc-shuffle { display:inline-flex; align-items:center; gap:6px; background:transparent; border:1px solid var(--border2); color:var(--text3); font-size:12px; font-weight:600; cursor:pointer; padding:6px 12px; border-radius:9px; font-family:'JetBrains Mono',monospace; transition:all .12s; }
  ...
  .fc-course-tab { padding:6px 14px; border:1px solid var(--border2); background:var(--bg3); color:var(--text3); font-size:12px; font-weight:700; border-radius:9px; cursor:pointer; font-family:'JetBrains Mono',monospace; transition:all .12s; }
  ...
  .fc-card-inner { position:relative; width:100%; min-height:300px; transition:transform .34s cubic-bezier(.2,.75,.25,1); transform-style:preserve-3d; }
  ...
  .fc-term { font-family:'JetBrains Mono',monospace; font-size:25px; letter-spacing:-0.5px; font-weight:800; color:var(--text); line-height:1.1; }
  ...
  .fc-gloss-link { display:inline-flex; align-items:center; gap:6px; margin-top:18px; background:transparent; border:1px solid var(--border2); color:var(--text3); font-family:'JetBrains Mono',monospace; font-size:11px; font-weight:600; padding:5px 12px; border-radius:8px; cursor:pointer; transition:border-color .15s, color .15s; }
  ...
  .fc-grade-btn { padding:13px; border-radius:var(--radius); border:1px solid; font-family:'JetBrains Mono',monospace; font-size:14px; font-weight:800; cursor:pointer; transition:all .15s; display:flex; align-items:center; justify-content:center; gap:7px; }
  ...
  .fc-results-score { font-family:'JetBrains Mono',monospace; font-size:42px; font-weight:800; line-height:1; }
  ...
  .fc-btn { display:inline-flex; align-items:center; gap:7px; padding:11px 20px; border-radius:var(--radius); font-family:'JetBrains Mono',monospace; font-size:13px; font-weight:700; cursor:pointer; transition:all .15s; border:1px solid var(--border2); background:var(--bg4); color:var(--text2); }
  ...
  .fc-kbd-hint kbd { font-family:'JetBrains Mono',monospace; font-size:10px; font-weight:700; color:var(--text2); background:var(--bg4); border:1px solid var(--border2); border-bottom-width:2px; border-radius:5px; padding:1px 6px; }
...
function _fcSavedMode() { try { const m = localStorage.getItem('lt_fc_mode'); return (m === 'def' || m === 'term') ? m : 'term'; } catch (_) { return 'term'; } }
window._fcSetMode = function(m) { if (!_fc) return; _fc.mode = m; _fc.flipped = false; try { localStorage.setItem('lt_fc_mode', m); } catch (_) {} _fcRender(); };
