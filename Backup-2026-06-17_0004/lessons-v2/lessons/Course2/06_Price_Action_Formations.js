  ...
  beats: [
    ...
    },
    {
      ...
      show: [
        ...
        { kind: 'marker', at: 'engulf', label: 'sellers engulf it', style: 'sweep', place: 'below' }
      ]
    },
    {
      id: 'morning-star',
    ...
    },
    {
      ...
      say: "Flip it and you get an evening star at a top. A strong up candle, then an indecision candle as buyers stall at a supply zone, then a down candle that closes past the midpoint of the first. Sellers confirm the reversal. The three-inside-up and three-inside-down formations follow the same logic, and tend to be excellent triggers at key levels.",
      show: [
        { kind: 'level',  at: 'midpoint', label: 'midpoint of candle 1', side: 'right' },
        { kind: 'marker', at: 'star',    label: 'indecision', style: 'dot', place: 'above' },
        { kind: 'marker', at: 'confirm', label: 'closes past midpoint — bearish', style: 'sweep', place: 'below' }
      ]
    },
    {
      id: 'soldiers',
    ...
    },
    {
      ...
      say: "And the bearish twin: three black crows. Three strong down candles in sequence, each with little or no lower wick, sellers pressing price lower every session. When you see this after an uptrend, it's a loud warning that control has flipped decisively to the downside.",
      show: [
        { kind: 'marker', at: 'crow1', label: 'sellers take over', style: 'dot', place: 'above' },
        { kind: 'marker', at: 'crow3', label: 'continuation down', style: 'sweep', place: 'below' }
      ]
    },
    {
      id: 'recap',
